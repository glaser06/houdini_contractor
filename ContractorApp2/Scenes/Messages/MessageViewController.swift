...
//        super.init(tableViewStyle: .plain)
    ...
    override func viewDidLoad()
    {
        ...
        self.tableView?.register(UINib(nibName: "ReceiverImageMessageCell", bundle: nil), forCellReuseIdentifier: ImageMessageTableViewCell.identifier+"2")
...
//        }
    ...
    func addActionSheet() {
        ...
        let schedule = UIAlertAction(title: "Schedule", style: .default) { (action) in
            self.sendSchedule()
        }
        let cancel = UIAlertAction(title: "Cancel", style: .cancel, handler: nil)
//        sheet.addAction(camera)
        sheet.addAction(quote)
        sheet.addAction(schedule)
...
extension MessageViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if message.sender == Auth.auth().currentUser!.uid {
            ...
            if let m = message as? Message.ImageMessage {
                var a = tableView.dequeueReusableCell(withIdentifier: ImageMessageTableViewCell.identifier+"2") as! ImageMessageTableViewCell
                a.setCell(img: m.image!)
                cell = a
